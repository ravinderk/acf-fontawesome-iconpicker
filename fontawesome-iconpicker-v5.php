...
class FontAwesome_IconPicker extends acf_field {
	...
	function __construct() {
		...
		$this->settings = array(
			...
			'config' 	=> 	plugins_url( 'lib/fontawesome-config.json', __FILE__),
			'icons'		=>	plugins_url( 'lib/Font-Awesome/css/font-awesome.min.css', __FILE__),
			'version' 	=> 	'0.1.0'
		);
	...
	function frontend_enqueue() {
		...
		wp_register_style( 'fontawsome', $this->settings['icons'], array(), '4.5.0' );
